...
import { deletePromotion, getPromotion } from "../api/main";
        ...
        <>
          {promotion.status == "pending" && (
            <div className="flex justify-end mb-5">
              ...
              >
                {apiCalled ? "Deleting..." : "Delete Promotion"}
              </button>
            </div>
          )}
          <div className="flex gap-[2%]">
            <div className="w-[65%] gap-5 flex flex-col">
              <div className="p-5 border rounded-lg flex flex-col gap-7 shadow-lg bg-[rgba(255,255,255,0.5)]">
                <div>
            ...
            <div className="p-5 border rounded-lg w-[33%] flex flex-col gap-10 shadow-lg bg-[rgba(255,255,255,0.5)]">
